...
import 'package:polydiff/services/image_update.dart';
...
class GamePageClassic1v1 extends StatefulWidget {
  ...
  @override
  State createState() => _GamePageClassic1v1State();
}
...
class _GamePageClassic1v1State extends State<GamePageClassic1v1> {
  ...
  void initState() {
    ...
    _foundDiffSubscription =
      ...
      setState(() {
        differencesDetectionService.setDifference(widget.diff);
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        ...
                        PlayAreaWidget(img: widget.img1, diff: widget.diff),
                      ],
                    ),
                  ),
                  Column(
                    ...
                    child: Column(
                      children: [
                        ...
                        PlayAreaWidget(
                            img: widget.img2,
                            diff: widget
                                .diff), // Import the correct file for the Difference class
                      ],
                    ),
                  ),
                ],
