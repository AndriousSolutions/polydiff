...
import 'package:polydiff/components/gif_picker.dart';
import 'package:polydiff/services/chat_mute.dart';
...
class _MessageSideBarState extends State<MessageSideBar>
  ...
  var newMessageList = [];
  var _toggleButtonSelected = [true, false];
  var indexFilter = 0;
                  ...
                  return Card(
                    child: ListTile(
                      leading: i['sender'] == User.username
                          ? null
                          : Image.network(
                              '${dotenv.env['SERVER_URL_AND_PORT']}avatars/avatar1.png'),
                      trailing:
