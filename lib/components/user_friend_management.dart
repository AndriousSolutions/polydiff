          ...
          child: ElevatedButton(
            ...
            child: (() {
              if (FriendsService.friends.contains(widget.friend.id)) {
                ...
                return Text(LanguageController()
                    .translate(frenchString: 'Ajouter', englishString: 'Add'));
              }
            }()),
          ),
        ),
        if (FriendsService.receivedFriendRequests.contains(widget.friend.id))
          SizedBox(
            width: 120, // Set your desired width here
            child: ElevatedButton(
              onPressed: () {
              ...
              child: Text(LanguageController()
                  .translate(frenchString: 'Refuser', englishString: 'Reject')),
            ),
          ),
      ],
    );
