...
import 'package:polydiff/services/game_constants_service.dart';
...
// constructor with type GameAccessType
  GameConstantsScreen({super.key, required this.gameAccessType});

  @override
  State createState() => _GameConstantsScreenState();
}
