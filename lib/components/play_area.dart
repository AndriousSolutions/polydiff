...
class PlayAreaWidget extends StatefulWidget {
  ...
  PlayAreaWidget({super.key, required this.img, this.diff});
...
class PlayAreaWidgetState extends State<PlayAreaWidget> {
  ...
  void clickHandle(TapDownDetails details) {
    ...
    lastPosition = renderBox.globalToLocal(details.globalPosition);

    print('Position du clic: ${lastPosition.dx}, ${lastPosition.dy}');
    ...
    differencesDetectionService.mouseHitDetect(
        lastPosition.dx, lastPosition.dy, widget.diff);
  }
